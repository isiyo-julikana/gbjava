...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Общий вес корзины: " + box2.getWeight());

        System.out.println("Результат работы метода compare() класса Box, параметры (пример: box1.compare(box2))");
        System.out.println("Массы корзин " + (box1.compare(box2) ? "одинаковы" : "различны") + ".");
        ...
        System.out.println("Сравниваем две корзины");
        System.out.println("Массы корзины " + (box1.compare(box2) ? "одинаковы" : "различны") + ".");
    }
